...
impl ProtectionConfig {
    ...
    pub fn example_toml() -> &'static str {
        r#"# tuai Protection Configuration
...
# log_file = "/var/log/tuai-protection.log"
...
/// Protection service that handles events and logging
...
impl ProtectionService {
    ...
    pub fn handle_event(&self, event: &ProtectionEvent) {
        tracing::warn!(
            target: "protection",
            pid = event.pid,
